...
dtypes_questions = {'Id':'int32', 'ParentId':'int32','Score': 'int16', 'Body': 'str'}

df_questions = pd.read_csv('pythonpack/answers.csv',
...
df_questions[['Body']] = df_questions[['Body']].applymap(lambda x: str(x).encode("utf-8", errors='surrogatepass').decode("ISO-8859-1", errors='surrogatepass'))
...
# Parse question then return only the text
...
df_questions['Text'] =  df_questions['Body']


df_questions.to_csv('df_answers_fullclean.csv', encoding='utf-8', errors='surrogatepass')
